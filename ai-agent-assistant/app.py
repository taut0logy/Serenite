...
async def get_feedback_analytics():
    ...
    themes = {}
    common_keywords = [
        "unclear", "confusing", "irrelevant", "wrong", "unhelpful", 
        "incomplete", "specific", "detail", "emotion", "empathy",
        "address", "listen", "understand", "context", "more", "less"
    ]
    ...
    for item in feedback_data:
        try:
            date_str = item.get("timestamp", "").split("T")[0]  # Extract just the date part
            if date_str:
