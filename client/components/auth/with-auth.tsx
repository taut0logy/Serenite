 ...
 */
export function withPublicRoute<P extends object>(Component: ComponentType<P>, redirectTo = '/dashboard') {
 ...
 */
export function withProtectedRoute<P extends object>(Component: ComponentType<P>, redirectTo = '/auth/login') {
  return withAuth(Component, {
    requireAuth: true,
    requireVerified: false,
 ...
 */
export function withVerifiedRoute<P extends object>(Component: ComponentType<P>, redirectTo = '/auth/login') {
  return withAuth(Component, {
    requireAuth: true,
