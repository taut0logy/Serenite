...
export default function BreathingExercisePage() {
    ...
    const [isFocalPointAnimated, setIsFocalPointAnimated] =
                ...
                if (
                    ...
                    toast.error(
                        <div className="space-y-2">
                            ...
                            <p>
                                Could not connect to the breathing exercise
                                server.
                            </p>
    ...
    const getLocalDefaultExercise = (): BreathingPattern => {
        return {
            name: "Calm Relief",
            description:
                "A gentle, slow breathing exercise to reduce stress and alleviate headaches.",
            steps: [
                {
                    action: "inhale",
                    duration: 4,
                ...
                },
                {
                    ...
                    duration: 2,
                    instruction:
                        "Hold your breath, allowing your body to relax",
                },
                {
                    action: "exhale",
                    duration: 6,
                ...
                },
                {
                    ...
                    duration: 2,
                    instruction:
                        "Hold before breathing in again, feeling calm and centered",
                },
            ],
            duration_minutes: 5,
            benefits: [
    ...
    const generateBreathingData = (steps: BreathingStep[]) => {
        ...
        const totalCycleDuration = steps.reduce(
            (acc, step) => acc + Math.max(step.duration, 1),
            0
        );
        ...
        const stepsWithContext = validSteps.map((step, index) => {
            ...
            const holdType =
                prevStep.action === "inhale" ? "after-inhale" : "after-exhale";
        ...
        for (let i = 0; i < totalSeconds; i++) {
            ...
            for (let j = 0; j < stepsWithContext.length; j++) {
                ...
                if (
                    cyclePosition >= currentSecond &&
                    cyclePosition < currentSecond + step.duration
                ) {
                    currentStepIndex = j;
                    break;
                }
            ...
            const stepPosition =
                (cyclePosition - currentSecond) / currentStep.duration;
            ...
            if (currentStep.action === "inhale") {
                ...
                if (currentStep.holdType === "after-inhale") {
                    ...
                    breathLevel -=
                        Math.sin(stepPosition * Math.PI * 4) * waveAmount;
                } else {
    ...
    const startExercise = () => {
        ...
        console.log(
            `Starting exercise with step: ${exercise.steps[0].action}, duration: ${firstStepDuration}s`
        );
            ...
            setSecondsRemaining((prev) => {
                if (prev <= 1) {
                    ...
                    setCurrentStepIndex((currentIdx) => {
                        ...
                        const nextIdx =
                            (currentIdx + 1) % exercise.steps.length;

                        // Get the next step's duration (ensure minimum 1s)
                        const nextDuration = Math.max(
                            exercise.steps[nextIdx].duration,
                            1
                        );
                        ...
                        console.log(
                            `From: Step ${currentIdx} (${exercise.steps[currentIdx].action})`
                        );
                        console.log(
                            `To: Step ${nextIdx} (${exercise.steps[nextIdx].action})`
                        );
                        console.log(`Duration: ${nextDuration}s`);
                        console.log(
                            `Total steps in sequence: ${exercise.steps.length}`
                        );
                        console.log(
                            `Sequence: ${exercise.steps
                                .map((s: BreathingStep) => s.action)
                                .join(" -> ")}`
                        );
                        console.log(`==========================`);
                        ...
                        >
                            <Card className="h-full shadow-lg border-t-4 border-t-primary">
                                <CardHeader className="pb-2">
                                    ...
                                    <CardDescription>
                                        Tell us about your current state, and
                                        we&apos;ll recommend a personalized
                                        breathing exercise to help.
                                    </CardDescription>
                                </CardHeader>
                                                ...
                                                <ul className="space-y-1.5">
                                                    {exercise.suitable_for.map(
                                                        (
                                                            ...
                                                            <li
                                                                key={index}
                                                                className="text-sm text-muted-foreground border border-primary/10 rounded-full px-3 py-1 inline-block m-1"
                                                            >
                                                                {person}
                                                            </li>
                                                        )
                                                    ...
                                                    (
                                                        ...
                                                        >
                                                            <div className="flex items-center justify-between">
                                                                ...
                                                                <span className="text-sm bg-primary/5 px-2 py-0.5 rounded-full">
                                                                    {
                                                                        step.duration
                                                                    }
                                                                    s
                                                                        ...
                                                                        duration:
                                                                            Math.max(
                                                                                exercise
                                                                                    ...
                                                                                    0.8,
                                                                                1
                                                                            ), // Scale duration relative to step duration
                                                                        ease: "easeInOut",
                                                                    },
                                                                    boxShadow: {
                                                                        duration: 2,
                                                                ...
                                                                {exercise.steps[
                                                                    ...
                                                                    <>
                                                                        ...
                                                                        <motion.div
                                                                            ...
                                                                            style={{
                                                                                border: `4px solid ${getActionColor(
                                                                                    "hold"
                                                                                )}`,
                                                                                width: "140px",
                                                                                height: "140px",
                        ...
                        {[
                            {
                                ...
                                emotion: "I'm feeling anxious and worried",
                                level: 7,
                            },
                            {
                                title: "Boost Focus",
                                description: "Box breathing for concentration",
                                emotion: "I need to focus better",
                                level: 4,
                            },
                            {
                                title: "Reduce Stress",
                                description: "Deep diaphragmatic breathing",
                                emotion: "I'm feeling stressed and tense",
                                level: 8,
                            },
                            {
                                title: "Sleep Better",
                                description: "Relaxing pre-sleep exercise",
                                emotion: "I'm having trouble falling asleep",
                                level: 5,
                            },
                        ].map((template, i) => (
                            <Card
