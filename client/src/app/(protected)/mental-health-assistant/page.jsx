...
export default function MentalHealthAssistant() {
  ...
  useEffect(() => {
    ...
    const loadChatHistory = async () => {
      if (storedUserId) {
        try {
          const response = await axios.get(`/chat/history/${storedUserId}`);
  ...
  //     const response = await axios.post(`/chat/record-voice?duration=${recordingTime > 0 ? recordingTime : 5}`, {
  ...
  const addEmotionToJournal = async (emotion, score, note, source) => {
    try {
      ...
      await axios.post('http://localhost:8000/emotion-journal/add', entry);
        ...
        return (
          <div className="p-5 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <Link href="/mental-health-assistant/chat/resources" className="block">
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] bg-muted/30 dark:bg-gray-950">
      {/* Header */}
        ...
        <div className="flex justify-between items-center max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-1">
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Link href="/mental-health-assistant/chat/resources">
