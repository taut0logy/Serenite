            ...
            <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                ...
                <div className="space-y-4 text-sm">
                    <section>
                        ...
                        <p>
                            By subscribing to our premium service, you agree to
                            the following terms:
                        </p>
                        <ul className="list-disc pl-6 mt-2 space-y-2">
                            ...
                            <li>
                                Refunds are processed according to our refund
                                policy
                            </li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            We take your privacy seriously. Your data will be:
                        </p>
                        <ul className="list-disc pl-6 mt-2 space-y-2">
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 mt-2 space-y-2">
                            <li>
                                Your card details are never stored on our
                                servers
                            </li>
            ...
            <div className="container mx-auto py-12 px-4">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="mt-8 flex justify-center gap-6">
                        <img
                            src="/payment-badges/stripe.svg"
                            alt="Powered by Stripe"
                            className="h-8"
                        />
                        <img
                            src="/payment-badges/visa.svg"
                            alt="Visa"
                            className="h-8"
                        />
                        <img
                            src="/payment-badges/mastercard.svg"
                            alt="Mastercard"
                            className="h-8"
                        />
                    </div>
