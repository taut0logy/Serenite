  ...
  async function onSubmit(data: LoginFormValues) {
    ...
    try {
      ...
      if (!checkResult?.success) {
        ...
        if(checkResult?.message === "Please verify your email before logging in") {
      ...
      if (checkResult?.success && checkResult?.requiresTwoFactor) {
        ...
        router.push(`/auth/verify-otp?userId=${checkResult.userId}&tempToken=${checkResult.tempToken}&email=${data.email}`);
        return;
      }
        ...
        <div className="mt-8">
          <div className="space-y-6">
            ...
            <div className="text-center text-xs text-muted-foreground">
              <p>Social login accounts will be automatically linked with existing email accounts</p>
            </div>
