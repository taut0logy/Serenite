                ...
                <CardFooter className="border-t pt-3 flex flex-wrap gap-2 justify-between">
                    <div className="flex flex-wrap gap-1 md:gap-2">
                        <Button
                            ...
                            className={cn(
                                "rounded-full",
                                post.reactionCounts.LIKE > 0 && "text-blue-500"
                            )}
                        ...
                        <Button
                            ...
                            className={cn(
                                "rounded-full",
                                post.reactionCounts.HEART > 0 && "text-red-500"
                            )}
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            delete your post and all its comments.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
