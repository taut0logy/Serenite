...
export default function EmotionJournal() {
    ...
    const formatTimestamp = (timestamp: JournalEntry["timestamp"]) => {
        if (!timestamp) return "";
    ...
    return (
        <div className="h-full flex flex-col">
            <div className="px-4 py-3 border-b border-gray-200 flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm text-gray-500">
                        Track your emotional states over time
                    </p>
                </div>
                {!showForm && (
                    <button
            ...
            {notification && (
                <div
                    className={`mx-4 mt-2 p-2 rounded-md ${
                    ...
                    <div className="text-sm text-blue-700">
                        {patterns.most_common && (
                            <div className="mb-2">
                                ...
                                <span
                                    className={`ml-2 px-2 py-0.5 rounded-full text-xs ${getEmotionColorClass(
                                        patterns.most_common
                                    )}`}
                                >
                            ...
                            <div>
                                ...
                                <ul className="space-y-1 ml-2">
                                    <li className="flex items-center">
                                        ...
                                        <span
                                            className={`px-2 py-0.5 rounded-full text-xs ${getEmotionColorClass(
