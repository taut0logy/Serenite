...
const gradientTextVariants = {
    ...
    visible: {
        ...
        transition: {
            duration: 0.8,
            delay: 0.8, // Reveals after the main text
            ease: "easeOut",
        },
    },
};
    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            >
                ...
                >
                    No shame, no pressure <br />
                    <span className="text-primary dark:text-primary/90">
                        {" "}
                        — just{" "}
                        <motion.span
                            className="bg-gradient-to-r from-primary via-purple-500 to-pink-500 dark:from-primary/90 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent bg-[length:200%_100%] font-extrabold"
                ...
                <motion.p
                    ...
                    variants={itemVariants}
                >
                    Personalized therapy for every step of your journey, with
                    people who care.
                </motion.p>
