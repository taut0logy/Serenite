...
import { Check, X, HelpCircle, Sparkles, Shield, Zap, Clock, Users, Crown } from "lucide-react";
...
const plans: SubscriptionPlan[] = [
  {
    ...
    features: [
      ...
      { text: "Unlimited group access", included: false, tooltip: "Join as many groups as you want" },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Monthly wellness reports", included: true, tooltip: "Detailed insights about your progress" },
      ...
      <div className="container mx-auto py-12 px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground font-['Inter'] max-w-2xl mx-auto">
            Select the perfect plan for your journey of growth and connection
          </p>
          
          <div className="flex items-center justify-center gap-4 mt-8">
            <span className={`text-sm ${!isYearly ? 'text-blue-600 dark:text-blue-400' : 'text-muted-foreground'}`}>
              Monthly
            </span>
            <Switch
              checked={isYearly}
            ...
            <span className={`text-sm ${isYearly ? 'text-blue-600 dark:text-blue-400' : 'text-muted-foreground'}`}>
              Yearly
              <Badge variant="secondary" className="ml-2 bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-300">
                Save 20%
              </Badge>
            </span>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <AnimatePresence>
            {plans.map((plan) => (
              ...
              >
                <Card className={`relative backdrop-blur-sm bg-white/90 dark:bg-black/20 border-none shadow-lg hover:shadow-xl transition-all duration-300 
                  ...
                  {plan.isPopular && (
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                      <Badge className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-4 py-1">
                        <Crown className="w-4 h-4 mr-1 inline-block" /> Most Popular
                      </Badge>
                    </div>
                  )}
                  ...
                  <CardHeader className="p-6">
                    <div className="flex justify-between items-start">
                      <div>
                        <h3 className="text-2xl font-bold font-['Space_Grotesk']">{plan.title}</h3>
                        {plan.badge && (
