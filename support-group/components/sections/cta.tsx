        ...
        >
          ...
          >
            ...
            <span className="relative inline-block">
              <span className="relative z-10">Better Mental Health?</span>
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Take the first step today. Our therapists are here to support you every
            step of the way.
          </motion.p>
          ...
          >
            <div className="flex gap-3">
              ...
              />
              <Button
                className="h-12 bg-background hover:bg-background/90 text-primary hover:text-primary/90 gap-2 whitespace-nowrap font-semibold px-6 transition-all duration-300"
              >
                Get Started
