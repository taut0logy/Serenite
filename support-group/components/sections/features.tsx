      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Why Choose{" "}
            <span className="text-primary dark:text-primary/90">MindfulSupport</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Experience a new standard of mental health care with our comprehensive features
            designed to support your well-being journey.
          </p>
        </motion.div>
                ...
                <div className="relative z-10">
                  <div className="mb-6">
                    <div className="w-14 h-14 rounded-full bg-background flex items-center justify-center ring-2 ring-border group-hover:ring-primary/20 transition-all">
                      <feature.icon className={`w-7 h-7 ${feature.iconColor} transition-transform group-hover:scale-110`} />
                    </div>
                  </div>
